...
union ekf_fault_status_u {
    struct
    {
        ...
        bool bad_acc_vertical : 1; ///< 9 - true if bad vertical accelerometer data has been detected
        bool bad_acc_clipping : 1; ///< 10 - true if delta velocity data contains clipping (asymmetric railing)
    } flags;
    uint32_t value;
};
