function(apx_use_module module)
    ...
    if(NOT ${module} IN_LIST modules)
        ...
        if(EXISTS "${module_path}/CMakeLists.txt")
            get_property(module_paths GLOBAL PROPERTY APX_MODULE_PATHS)
            if(NOT ${module_path} IN_LIST module_paths)
                set_property(GLOBAL APPEND PROPERTY APX_MODULE_PATHS ${module_path})
                add_subdirectory(${module_path} ${dest_path})
            endif()
        else()
            message(STATUS "Skipped module: ${module} (${module_path})")
        endif()
    endif()
endfunction()
