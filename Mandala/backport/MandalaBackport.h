...
static constexpr const item_t items[] = {
    ...
    MBVECT(est::nav::rel::ax::meta, Ax, f2, s1, 0),
    MBVECT(est::nav::rel::ay::meta, Ay, f2, s1, 1),
    MBVECT(est::nav::rel::az::meta, Az, f2, s1, 2),

    MBVECT(est::nav::att::p::meta, p, f2, s10, 0),
    ...
    MBVECT(est::nav::pos::vn::meta, gps_Vnorth, f2, f2, 0),
    MBVECT(est::nav::pos::ve::meta, gps_Veast, f2, f2, 1),
    MBVECT(est::nav::pos::vd::meta, gps_Vdown, f2, f2, 2),
    ...
    MBVECT(est::nav::agl::status::meta, status_agl, bit, bit, 8),
    ...
    MBVECT(est::nav::pos::n::meta, pos_north, f4, f4, 0),
    MBVECT(est::nav::pos::e::meta, pos_east, f4, f4, 1),
    ...
    MBVECT(est::nav::rel::vx::meta, Vx, f4, f4, 0),
    MBVECT(est::nav::rel::vy::meta, Vy, f4, f4, 1),
    MBVECT(est::nav::rel::dx::meta, dx, f4, f4, 0),
    MBVECT(est::nav::rel::dy::meta, dy, f4, f4, 1),
