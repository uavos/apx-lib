...
static constexpr const ds_field_s dataset_haps[] = {
    ...
    ds<est::env::haps::pitch1>(fmt_rad2),
    ds<est::env::haps::pitch2>(fmt_rad2),
    ds<est::env::haps::cpitch1>(fmt_rad2),
    ds<est::env::haps::cpitch2>(fmt_rad2),
